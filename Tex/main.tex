...
\chapter{Das Musikleben im 18. Jahrhundert}\label{18jh}
...
Wie in Kaptiel \ref{18jh} dargestellt, bestanden die frühen Formen des Konzerts aus einem Potpourri von verschiedenen Stücken, Arien, Tänzen und virtuosen Stücken. Das Liebhaberkonzert hatte anfangs eine ähnliche Zusammensetzung.

Ausgehend vom Virtuosenkult um einzelne Instrumentalisten wie Franz Liszt oder Niccolò Paganini veranstalteten einzelne Musiker Konzerte, in denen sie selbst, sowie befreundete MusikerInnen auftraten. 


\subsection{Lebensstil}
\label{lebensstil}
