...
% Fußnote zur obigen Grafik
\footnotetext{Erläuterung der Grafik: Auf der vertikalen Achse befindet sich das allgemeine Kapitalvolumen, das der Summe der verschiedenen Kapitalsorten entspricht. Im oberen Bereich finden sich also Personen, die allgemein ein hohes Kapitalvolumen aufweisen, im unteren Bereich Personen, die über ein niedriges Kapitalvolumen verfügen. Die horizontale Achse differenziert nach kulturellem und ökonomischen Kapital: Auf der linken Seite befinden sich Personen mit tendenziell höherem kulturellen Kapital und geringerem ökonomischen Kapital, auf der rechten Seite Personen mit hohem ökonomischen, aber niedrigem kulturellen Kapital.}
...
Bourdieu unterscheidet hierbei zwischen dem \emph{legitimen}, dem \emph{mittleren} und dem \emph{populären} Geschmack. Der \emph{legitime} Geschmack steht für Werke und Praktiken, die der Ästhetik der herrschenden Klasse entsprechen, insofern durch sie \enquote{legitimiert} werden. \parencite[vgl.][551]{joas_sozialtheorie:_2004} In der Welt der Musik stehen für ihn Werke wie Bachs \enquote{Kunst der Fuge} oder Ravels \enquote{Konzert für die linke Hand} für den legitimen Geschmack. Der \emph{mittlere} Geschmack bezieht sich auf Werke wie Gershwins \enquote{Rhapsody in Blue} oder Brahms' \enquote{Ungarische Tänze}, und ist \textquote[{\cite[38]{bourdieu_feinen_2012}}]{häufiger bei Angehörigen der Mittelklassen als in Arbeiterkreisen oder [der] (...) herrschenden Klasse anzutreffen.} Übrig bleibt der \emph{populäre} Geschmack, welcher Werken der \enquote{leichten} Unterhaltung, sowie durch ihre starke Verbreitung \enquote{entwertete} Werke wie Strauss' \enquote{An der schönen blauen Donau} und Verdis \enquote{La Traviata} entspricht. \parencite[vgl.][38]{bourdieu_feinen_2012}
...
\begin{figure}[ht]
	\centering
  		\includegraphics[scale=1.1]{Korrespondenz.pdf}
	\caption{Berufsgruppen versus Konzertpublika. Quelle: \cite[487]{de_la_motte-haber_konzertpublika_2007}\protect\footnotemark } %Fußnote findet sich weiter unten
...
% Fußnote für die Grafik
\footnotetext{Erläuterung der Grafik: Von den vielen in der Grafik interpretierbaren Zusammenhängen möchte ich jene, die für die vorliegende Arbeit bedeutsam sind, herausgreifen. Die mit einem Kreuz gekennzeichneten Punkte entsprechen den Publika der verschiedenen Stilrichtungen. Die anderen Punkte sind die Berufsgruppen der befragten Personen. Die Beziehung innerhalb der Konzertgenres ist sehr deutlich: Die klassischen Konzerte sind sich hinsichtlich ihrer Publika sehr ähnlich. Einzig die dem Jazz zuordenbaren Konzerte befinden sich in der Nähe, weisen also ein ähnliches Publikum auf. Die Beziehung zu den Berufsgruppen lässt sich wie folgt interpretieren: Konzertgenres und Berufsgruppen, welche, vom Nullpunkt aus gesehen in der gleichen Richtung liegen, korrespondieren miteinander. In dieser Grafik korrespondieren also die Konzerte mit klassischer Musik (Wagner, Klaviertrio, Berliner Philharmoniker), mit den Berufsgruppen der Geistes-, Sozial-, und politikwissenschaftlichen Berufe, der ÄrztInnen, JuristInnen, NaturwissenschafterInnen, HochschullehrerInnen et cetera.}
